...
df_2012 = pd.read_excel("/Pop_Brasil/POP2012_Municipios.xls", header=1, sheet_name="Municípios")
df_2013 = pd.read_excel("/Pop_Brasil/POP2013_Municipios.xls", header=2)
df_2014 = pd.read_excel("/Pop_Brasil/POP2014_Municipios.xls", header=2, sheet_name="Municípios")
df_2015 = pd.read_excel("/Pop_Brasil/POP2015_Municipios.xls", header=2, sheet_name="Municípios")
df_2016 = pd.read_excel("/Pop_Brasil/POP2016_Municipios.xls", header=1, sheet_name="Municípios")
df_2017 = pd.read_excel("/Pop_Brasil/POP2017_Municipios.xls", header=1, sheet_name="Municípios")
df_2018 = pd.read_excel("/Pop_Brasil/POP2018_Municipios.xls", header=1, sheet_name="Municípios")
df_2019 = pd.read_excel("/Pop_Brasil/POP2019_Municipios.xls", header=1, sheet_name="Municípios")
df_2020 = pd.read_excel("/Pop_Brasil/POP2020_Municipios.xls", header=1, sheet_name="Municípios")
df_2021 = pd.read_excel("/Pop_Brasil/POP2021_Municipios.xls", header=1, sheet_name="Municípios")
df_2022 = pd.read_excel("/Pop_Brasil/POP2022_Municipios.xls", header=1)
